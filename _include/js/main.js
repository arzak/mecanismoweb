...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/image04.jpg', title : '<div class="slide-content">MECANISMOWEB</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image02.jpg', title : '<div class="slide-content">Responsive Design</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/tabletimage.jpg', title : '<div class="slide-content">SITIOS RESPONSIVOS</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image01.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/tendencia-web-diseno-responsive.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''}
...
CHAKRA.tweetFeed = function(){
    ...
    $("#ticker").tweet({
          username: "arzakg", // Change this with YOUR ID
          page: 1,
          avatar_size: 0,
          count: 10,
		  template: "{text}{time}",
